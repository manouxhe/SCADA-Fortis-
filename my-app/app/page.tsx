    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto grid min-h-[85vh] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-3xl text-base leading-7 text-[#B7C7D9] md:text-lg">
            ...
            technical voice across integration, interfaces, commissioning, and delivery.
      ...
      <section className="border-y border-white/10 bg-[#00233A]">
        <div className="mx-auto grid max-w-7xl gap-6 px-6 py-10 md:grid-cols-2 xl:grid-cols-5 xl:px-8">
          <div>
            <p className="text-3xl font-semibold text-[#00C8C8]">15+</p>
            <p className="mt-2 text-sm text-[#B7C7D9]">
              Years exclusively in offshore wind and HVDC
            </p>
          </div>
          <div>
            <p className="text-3xl font-semibold text-[#00C8C8]">10+ GW</p>
            <p className="mt-2 text-sm text-[#B7C7D9]">
              Capacity represented across European projects
            </p>
          </div>
          <div>
            <p className="text-3xl font-semibold text-[#00C8C8]">8+</p>
            <p className="mt-2 text-sm text-[#B7C7D9]">
              Major offshore wind projects delivered
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-[#B7C7D9]">
              Compliance-oriented OT security engineering
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-2 lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-[#00233A] p-8">
          ...
          <ul className="mt-6 space-y-4 text-[#B7C7D9]">
            ...
            <li>• Interface failures discovered too late in the project</li>
            <li>• Vendor interests misaligned with project interests</li>
            <li>• Commissioning pressure creates reactive decisions</li>
            <li>• Signal list conflicts found during SAT instead of FEED</li>
          </ul>
        </div>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-[#003057]/40 p-8">
          ...
          <ul className="mt-6 space-y-4 text-[#B7C7D9]">
            <li>• Independent technical oversight — no platform to sell</li>
            <li>• Interface management across all disciplines and vendors</li>
            <li>• Full lifecycle support from FEED through commissioning</li>
            <li>• IEC 61850, IEC 62443, and IEC 61400-25 expertise</li>
            <li>• Vendor-neutral signal register and conflict detection</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <div className="mb-10 max-w-2xl">
          ...
          <p className="mt-4 text-[#B7C7D9]">
            ...
            delivery risk reduction, and technical clarity across the full project lifecycle.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {[
            {
              title: "The Owner's Engineer",
              desc: "Independent technical oversight of the SCADA and telecom scope — protecting the developer's interests from FEED through final commissioning and handover.",
            },
            {
              title: "SCADA Engineering & Design",
              desc: "Architecture review, signal register ownership, interface matrix management, and vendor-neutral specification authoring for offshore wind control systems.",
            },
            {
              title: "Commissioning Management",
              desc: "FAT, SAT and SIT coordination, ITP witness, punch list governance, and commissioning documentation management across all SCADA and telecom systems.",
            },
            {
              title: "Interface Management",
              desc: "Structured management of technical interfaces between SCADA, protection, telecom, and third-party systems — identifying conflicts before they become delays.",
            },
            {
              title: "Cybersecurity & Compliance",
              desc: "IEC 62443 zone and conduit design, OT network segmentation, NIS2 compliance review, and cybersecurity scope ownership for offshore OT environments.",
            },
            {
              title: "Operational Support",
              desc: "Post-commissioning technical support, SCADA documentation review, operational handover, and long-term technical advisory for offshore wind developers.",
            },
          ].map((item) => (
            <div
              key={item.title}
            ...
            >
              ...
              <Link href="/services" className="mt-6 block text-sm font-semibold text-[#00C8C8]">
                Learn more →
              </Link>
            </div>
          ))}
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-[#00233A] p-8">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-white">
            Proven experience across major European offshore wind projects.
          </h2>
          <p className="mt-4 max-w-2xl text-[#B7C7D9]">
            15+ years delivering SCADA, telecom, and OT cybersecurity scope on 
            HVDC and HVAC offshore wind projects for Ørsted, Vattenfall, RWE, 
            EDF Renewables, and ENGIE Fabricom.
          </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-[#001828] p-5">
              ...
              <p className="mt-3 font-semibold text-white">Hornsea 3 HVDC</p>
              <p className="mt-1 text-sm text-[#B7C7D9]">Ørsted — North Sea</p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#001828] p-5">
              ...
              <p className="mt-3 font-semibold text-white">Site Engineer Representative</p>
              <p className="mt-1 text-sm text-[#B7C7D9]">320 kV VSC-HVDC</p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#001828] p-5">
              ...
              <p className="mt-3 font-semibold text-white">8+ major projects</p>
              <p className="mt-1 text-sm text-[#B7C7D9]">across 6 developers</p>
            </div>
          </div>

          <div className="mt-6">
            <Link href="/projects" className="text-sm font-semibold text-[#00C8C8]">
              View all projects →
            </Link>
          </div>
        </div>
      ...
      <section className="pb-24 pt-6">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-gradient-to-r from-[#00233A] to-[#003057] px-8 py-14 text-center shadow-2xl shadow-black/20">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[#D3DEE9]">
            SCADA and telecom problems found in FEED cost a fraction of what they cost 
            during commissioning. Bring us in early — before the interfaces are locked 
